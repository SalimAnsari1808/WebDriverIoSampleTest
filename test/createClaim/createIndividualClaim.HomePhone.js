...
describe('GRS Claims Create Claim page Home Phone functionality',()=>{
    it('Should display Home phone field with text box with prefilled format (999) 999- 9999',()=>{
       ...
       expect(ElementUtil.getElementAttributeValue(CreateClaimPage.inputHomePhone,'placeholder')).to.be.equal('(999) 999-9999');
    });
    ...
    it('Should able to enter valid format into "Home phone" text box',()=>{
       ...
       var homePhone = "(634) 346-5853";
       CreateClaimPage.enterHomePhone(homePhone);

       expect(ElementUtil.getElementValue(CreateClaimPage.inputHomePhone)).to.be.equal(homePhone);
    });
